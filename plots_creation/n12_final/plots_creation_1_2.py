...
def _plot_protocol_and_fidelity(ax1: Axes, ax2: Axes, e_qs: EvolvingQubitSystem,
    ...
    # Panel 2
    ground_states, excited_states = StandardGHZState(e_qs.N)._get_components()
    labelled_states = [(ground_states, r"$\mathcal{F}_{GG}$"), (excited_states, r"$\mathcal{F}_{EE}$")]
...
def plot_BO_geometries_and_GHZ():
    ...
    save_current_fig("ee_gg_bo_geometries_ghz_protocol_and_fidelity")
