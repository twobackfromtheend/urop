...
s_qs_n_4.plot_detuning_energy_levels(True, savefig_name="energy_levels.png", show=True)
...
def solve_and_print_stats(e_qs: EvolvingQubitSystem):
    ...
    e_qs.plot(with_antisymmetric_ghz=get_ghz_state(N, False), savefig_name="evolving_fidelities.png", show=True)
